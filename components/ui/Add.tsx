...
const Add = () => {
  ...
  const [geometry, setGeometry] = useState<string>('sphere');
    ...
    <SubMenu title="cube_add">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input
          ...
          inline
          onChange={(value) =>
            setTranslation({ ...translation, x: Number(value) })
          }
        />
        <Input
          value="Y"
          inline
          onChange={(value) =>
            setTranslation({ ...translation, y: Number(value) })
          }
        />
        <Input
          value="Z"
          inline
          onChange={(value) =>
            setTranslation({ ...translation, z: Number(value) })
          }
        />
      </div>
      <div className="flex flex-col gap-2">
        ...
        <Input
          inline
          value="X"
          onChange={(value) => setRotation({ ...rotation, x: Number(value) })}
        />
        <Input
          inline
          value="Y"
          onChange={(value) => setRotation({ ...rotation, y: Number(value) })}
        />
        <Input
          inline
          value="Z"
          onChange={(value) => setRotation({ ...rotation, z: Number(value) })}
        />
      </div>
      <div className="flex flex-col gap-2">
        <strong>Scale</strong>
        <Input
          value="X"
          inline
          onChange={(value) => setScale({ ...scale, x: Number(value) })}
        />
        <Input
          value="Y"
          inline
          onChange={(value) => setScale({ ...scale, y: Number(value) })}
        />
        <Input
          value="Z"
          inline
          onChange={(value) => setScale({ ...scale, z: Number(value) })}
        />
      </div>
      <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2">
        <Input
          value="Linear Damping"
          onChange={(value) => setLinearDamping(Number(value))}
        />
      </div>
      <div className="flex flex-col gap-2">
        <Input
          value="Angular Damping"
          onChange={(value) => setAngularDamping(Number(value))}
        />
      </div>
      <div className="flex flex-col gap-2">
        <Input
          value="Gravity Scale"
          onChange={(value) => setGravityScale(Number(value))}
        />
      </div>
      <div className="flex flex-col gap-2">
        <Input
          value="Friction"
          onChange={(value) => setFriction(Number(value))}
        />
      </div>
      <div className="flex flex-col gap-2">
        <Input
      ...
      <button
        ...
        className="py-2 px-4 text-white bg-black rounded"
      >
        Add
      </button>
    </SubMenu>
...
const Input = ({
  ...
  return (
    <div
      className={`flex ${inline ? "flex-row items-center gap-2" : "flex-col items-start gap-0"}  justify-center `}
    >
...
const Choice = ({
  ...
  choices: { key: any; value: string; title?: string }[];
